...
@endif
     ...
     <form method="POST" action="/saveTeacherProfile" id="register_student" novalidate>
        ...
        <div class="form-group" id="otherSubjectWithLabel">
            ...
            <input type="text" class="form-control"  placeholder="Experience in" value="{{old('experience')}}" name="experience">
            @if ($errors->has('experience')) <p class="text-danger">{{ $errors->first('experience') }}</p> @endif
        </div>
